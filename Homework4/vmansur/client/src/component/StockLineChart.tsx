...
function drawChart(
  ...
  const brush = d3
    .brushX()
    .extent([[plotLeft, 0], [plotRight, brushH]]);
  ...
  svg
    .append("text")
    .attr("x", plotLeft).attr("y", hintTextY)
    .attr("fill", "#64748b").style("font-size", "10px")
    .text("Brush: drag range to zoom that period. Chart: mouse wheel zooms time. Scroll bar pans wide charts.");
